...
{
    { MOVE_FLAG_FORWARD,        MOVE_FLAG_BACKWARD,     0.3f },     // MOVE_TYPE_FORWARD
    { MOVE_FLAG_BACKWARD,       MOVE_FLAG_FORWARD,      0.3f },     // MOVE_TYPE_BACKWARD
    { MOVE_FLAG_STRAFE_LEFT,    MOVE_FLAG_STRAFE_RIGHT, 0.3f },     // MOVE_TYPE_STRAFE_LEFT
    { MOVE_FLAG_STRAFE_RIGHT,   MOVE_FLAG_STRAFE_LEFT,  0.3f },     // MOVE_TYPE_STRAFE_RIGHT
    ...
    { MOVE_FLAG_UPWARD,         MOVE_FLAG_DOWNWARD,     0.3f },     // MOVE_TYPE_UPWARD
    { MOVE_FLAG_DOWNWARD,       MOVE_FLAG_UPWARD,       0.3f },     // MOVE_TYPE_DOWNWARD
